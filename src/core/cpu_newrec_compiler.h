...
protected:
  enum FlushFlags : u32
  {
    ...
    FLUSH_FREE_ALL_REGISTERS = (1 << 3),
    FLUSH_PC = (1 << 4),
    FLUSH_INSTRUCTION_BITS = (1 << 5),
    FLUSH_CYCLES = (1 << 6),
    FLUSH_LOAD_DELAY = (1 << 7),
    FLUSH_LOAD_DELAY_FROM_STATE = (1 << 8),
    FLUSH_GTE_DONE_CYCLE = (1 << 9),
    FLUSH_GTE_STALL_FROM_STATE = (1 << 10),
